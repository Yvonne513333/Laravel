...
<template>
    ...
    <div
        ...
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
            ...
            <template v-else>
                <!-- <Link href="/Test"                     class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">去Test頁</Link> -->
        ...
        <div class="flex justify-center items-center flex-col">
            <img :src="testBg" alt="" class="w-[150px] h-[150px]">
